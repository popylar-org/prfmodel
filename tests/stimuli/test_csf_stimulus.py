...
import numpy as np
import pytest
from prfmodel.stimuli._csf import CSFStimulus
from prfmodel.stimuli._csf import CSFStimulusDimensionError
from prfmodel.stimuli._csf import CSFStimulusShapeError
